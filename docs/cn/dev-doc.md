...
3. 更新segment索引
   ```bash
   ./londobell-api-aggregators --repo ../multi multiquery-cfg update --new-url "<MONGO_URL>" --new-name lsk_history --db-type 1 --nodeconfig ./config.json --force
   ```
