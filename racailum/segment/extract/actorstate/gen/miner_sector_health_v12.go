...
func init() {
	reg.MustRegisterPreCheck("MinerSectorHealthV12", func(ctx *extract.Ctx) bool {
	...
	reg.MustRegisterRegularExtractor("MinerSectorHealthV12", extractMinerSectorHealthV12)
}

func extractMinerSectorHealthV12(ctx *extract.Ctx, res *extract.Res, head *common.ActorHead, st *miner12.State) error {
