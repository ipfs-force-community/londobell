...
func init() {
	reg.MustRegisterPreCheck("MinerSectorHealthV17", func(ctx *extract.Ctx) bool {
	...
	reg.MustRegisterRegularExtractor("MinerSectorHealthV17", extractMinerSectorHealthV17)
}

func extractMinerSectorHealthV17(ctx *extract.Ctx, res *extract.Res, head *common.ActorHead, st *miner17.State) error {
