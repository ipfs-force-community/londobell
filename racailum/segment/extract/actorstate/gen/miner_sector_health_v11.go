...
func init() {
	reg.MustRegisterPreCheck("MinerSectorHealthV11", func(ctx *extract.Ctx) bool {
	...
	reg.MustRegisterRegularExtractor("MinerSectorHealthV11", extractMinerSectorHealthV11)
}

func extractMinerSectorHealthV11(ctx *extract.Ctx, res *extract.Res, head *common.ActorHead, st *miner11.State) error {
