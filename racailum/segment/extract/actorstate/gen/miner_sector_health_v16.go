...
func init() {
	reg.MustRegisterPreCheck("MinerSectorHealthV16", func(ctx *extract.Ctx) bool {
	...
	reg.MustRegisterRegularExtractor("MinerSectorHealthV16", extractMinerSectorHealthV16)
}

func extractMinerSectorHealthV16(ctx *extract.Ctx, res *extract.Res, head *common.ActorHead, st *miner16.State) error {
