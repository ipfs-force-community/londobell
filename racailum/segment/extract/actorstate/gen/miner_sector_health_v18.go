...
func init() {
	reg.MustRegisterPreCheck("MinerSectorHealthV18", func(ctx *extract.Ctx) bool {
	...
	reg.MustRegisterRegularExtractor("MinerSectorHealthV18", extractMinerSectorHealthV18)
}

func extractMinerSectorHealthV18(ctx *extract.Ctx, res *extract.Res, head *common.ActorHead, st *miner18.State) error {
