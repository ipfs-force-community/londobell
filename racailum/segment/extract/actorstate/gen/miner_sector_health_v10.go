...
func init() {
	reg.MustRegisterPreCheck("MinerSectorHealthV10", func(ctx *extract.Ctx) bool {
	...
	reg.MustRegisterRegularExtractor("MinerSectorHealthV10", extractMinerSectorHealthV10)
}

func extractMinerSectorHealthV10(ctx *extract.Ctx, res *extract.Res, head *common.ActorHead, st *miner10.State) error {
