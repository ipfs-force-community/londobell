...
func init() {
	...
	if (miner6.MaxSectorExpirationExtension / builtin6.EpochsInDay) > summaryDaysV6[len(summaryDaysV6)-1] {
		summaryDaysV6 = append(summaryDaysV6, abi.ChainEpoch(miner6.MaxSectorExpirationExtension/builtin6.EpochsInDay))
	}
