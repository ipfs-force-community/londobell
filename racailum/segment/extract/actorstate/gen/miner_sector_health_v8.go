...
func init() {
	reg.MustRegisterPreCheck("MinerSectorHealthV8", func(ctx *extract.Ctx) bool {
	...
	reg.MustRegisterRegularExtractor("MinerSectorHealthV8", extractMinerSectorHealthV8)
}

func extractMinerSectorHealthV8(ctx *extract.Ctx, res *extract.Res, head *common.ActorHead, st *miner8.State) error {
