...
func init() {
	reg.MustRegisterPreCheck("MultisigBalanceV13", func(ctx *extract.Ctx) bool {
		return ctx.Opts.ZeroHourExtract.MultisigBalance
	}, nil)
	reg.MustRegisterRegularExtractor("MultisigBalanceV13", extractMultisigBalanceV13)

}

func extractMultisigBalanceV13(ctx *extract.Ctx, res *extract.Res, head *common.ActorHead, st *multisig13.State) error {
	epoch := head.Epoch
