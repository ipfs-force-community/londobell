...
func init() {
	reg.MustRegisterPreCheck("DealProposalDetailedV14", func(ctx *extract.Ctx) bool {
	...
	reg.MustRegisterRegularExtractor("DealProposalDetailedV14", extractDealProposalDetailedV14)

}

func extractDealProposalDetailedV14(ctx *extract.Ctx, res *extract.Res, head *common.ActorHead, st *market14.State) error {
	...
	state, err := lmarket.Load(adt14.WrapStore(ctx.C, ctx.D.ActorStore(ctx.C)), head.Actor)
	if err != nil {
