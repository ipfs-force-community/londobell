...
func init() {
	reg.MustRegisterPreCheck("DealProposalSummaryV4", func(ctx *extract.Ctx) bool {
	...
	reg.MustRegisterRegularExtractor("DealProposalSummaryV4", extractDealProposalSummaryV4)
