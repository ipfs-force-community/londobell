...
func init() {
	reg.MustRegisterPreCheck("MinerSectorHealthV15", func(ctx *extract.Ctx) bool {
	...
	reg.MustRegisterRegularExtractor("MinerSectorHealthV15", extractMinerSectorHealthV15)
}

func extractMinerSectorHealthV15(ctx *extract.Ctx, res *extract.Res, head *common.ActorHead, st *miner15.State) error {
