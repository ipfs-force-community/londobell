...
func init() {
	reg.MustRegisterPreCheck("DealProposalSummaryV6", func(ctx *extract.Ctx) bool {
	...
	reg.MustRegisterRegularExtractor("DealProposalSummaryV6", extractDealProposalSummaryV6)
