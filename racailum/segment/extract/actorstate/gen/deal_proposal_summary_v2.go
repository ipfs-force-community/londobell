...
func init() {
	reg.MustRegisterPreCheck("DealProposalSummaryV2", func(ctx *extract.Ctx) bool {
	...
	reg.MustRegisterRegularExtractor("DealProposalSummaryV2", extractDealProposalSummaryV2)
