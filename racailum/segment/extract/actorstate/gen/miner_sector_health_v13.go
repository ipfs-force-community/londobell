...
func init() {
	reg.MustRegisterPreCheck("MinerSectorHealthV13", func(ctx *extract.Ctx) bool {
	...
	reg.MustRegisterRegularExtractor("MinerSectorHealthV13", extractMinerSectorHealthV13)
}

func extractMinerSectorHealthV13(ctx *extract.Ctx, res *extract.Res, head *common.ActorHead, st *miner13.State) error {
