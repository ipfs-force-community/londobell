...
func init() {
	reg.MustRegisterPreCheck("MinerSectorHealthV14", func(ctx *extract.Ctx) bool {
	...
	reg.MustRegisterRegularExtractor("MinerSectorHealthV14", extractMinerSectorHealthV14)
}

func extractMinerSectorHealthV14(ctx *extract.Ctx, res *extract.Res, head *common.ActorHead, st *miner14.State) error {
