...
func init() {
	mustRegisterRegularExtractor("MarketFundsV3", extractMarketFundsV3)

}

func extractMarketFundsV3(ctx *extract.Ctx, res *extract.Res, head *common.ActorHead, st *market3.State) error {
	...
	proposals, err := market3.AsDealProposalArray(actStore, st.Proposals)
	if err != nil {
