...
func init() {
	mustRegisterRegularExtractor("MinerSectorHealthV2", extractMinerSectorHealthV2)
}

func extractMinerSectorHealthV2(ctx *extract.Ctx, res *extract.Res, head *common.ActorHead, st *miner2.State) error {
	...
	err = deadlines.ForEach(actStore, func(dlIdx uint64, dl *miner2.Deadline) error {
		if dl == nil {
			return nil
		}
