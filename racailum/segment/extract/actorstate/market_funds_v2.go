...
func init() {
	mustRegisterRegularExtractor("MarketFundsV2", extractMarketFundsV2)

}

func extractMarketFundsV2(ctx *extract.Ctx, res *extract.Res, head *common.ActorHead, st *market2.State) error {
	...
	proposals, err := market2.AsDealProposalArray(actStore, st.Proposals)
	if err != nil {
