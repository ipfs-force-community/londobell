...
type MinerRes struct {
	...
	Beneficiary              address.Address                 `json:"beneficiary"`
	BeneficiaryTerm          *miner.BeneficiaryTerm          `json:"beneficiary_term"`
	PendingBeneficiaryTerm   *miner.PendingBeneficiaryChange `json:"pending_beneficiary_term"`
}
