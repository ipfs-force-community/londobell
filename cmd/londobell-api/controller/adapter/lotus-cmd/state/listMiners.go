...
func GetStateListMiners(c *gin.Context) {
	alog := adapter.Log.With("method", "GetStateListMiners")
	req := lotusCmdModel.StateListMinersReq{}
	...
	res.Data = lotusCmdModel.StateListMinersRes{
		Epoch:  ts.Height(),
		Miners: miners,
	}
