...
var completeValueCmd = &cli.Command{
	Name:  "complete-value",
	...
	Action: func(cctx *cli.Context) error {
		...
		js, err := ioutil.ReadFile("./cmd/bell/merge.js")
		if err != nil {
			return err
		}
...
//mongodb://londo:bell@dds-uf655172d52c38641.mongodb.rds.aliyuncs.com:3717/bell?replicaSet=mgset-65444697
