...
func GetMinerInfo(c *gin.Context) {
	...
	case builtin3.StorageMinerActorCodeID:
		...
		precommitted, err := adt.AsMap(stor, state.PreCommittedSectors, builtin3.DefaultHamtBitwidth)
		if err != nil {
			res.Code = model.Fail
			res.Msg = err.Error()
			c.JSON(http.StatusOK, res)
	...
	case builtin4.StorageMinerActorCodeID:
		...
		precommitted, err := adt.AsMap(stor, state.PreCommittedSectors, builtin4.DefaultHamtBitwidth)
		if err != nil {
			res.Code = model.Fail
			res.Msg = err.Error()
			c.JSON(http.StatusOK, res)
	...
	case builtin5.StorageMinerActorCodeID:
		...
		precommitted, err := adt.AsMap(stor, state.PreCommittedSectors, builtin5.DefaultHamtBitwidth)
		if err != nil {
			res.Code = model.Fail
			res.Msg = err.Error()
			c.JSON(http.StatusOK, res)
	...
	case builtin6.StorageMinerActorCodeID:
		...
		precommitted, err := adt.AsMap(stor, state.PreCommittedSectors, builtin6.DefaultHamtBitwidth)
		if err != nil {
			res.Code = model.Fail
			res.Msg = err.Error()
			c.JSON(http.StatusOK, res)
	...
	case builtin7.StorageMinerActorCodeID:
		...
		precommitted, err := adt.AsMap(stor, state.PreCommittedSectors, builtin7.DefaultHamtBitwidth)
		if err != nil {
			res.Code = model.Fail
			res.Msg = err.Error()
			c.JSON(http.StatusOK, res)
	...
	//allSectors, err := miner.AllPartSectors(mas, miner.Partition.ActiveSectors)
	//if err != nil {
	//	res.Code = model.Fail
	//	res.Msg = err.Error()
	//	c.JSON(http.StatusOK, res)
	...
	//}
	//
	//sectorCount, err = allSectors.Count()
	//if err != nil {
	//	res.Code = model.Fail
	//	res.Msg = err.Error()
	//	c.JSON(http.StatusOK, res)
	...
	//}
	//
	//faultSectorCount, err = faultySectors.Count()
	//if err != nil {
	//	res.Code = model.Fail
	//	res.Msg = err.Error()
	//	c.JSON(http.StatusOK, res)
	...
	//}
	//
	//activeSectors, err := miner.AllPartSectors(mas, miner.Partition.ActiveSectors) //todo:network版本？
	//if err != nil {
	//	res.Code = model.Fail
	//	res.Msg = err.Error()
	//	c.JSON(http.StatusOK, res)
	...
	//}
	//
	//activeSectorCount, err = activeSectors.Count()
	//if err != nil {
	//	res.Code = model.Fail
	//	res.Msg = err.Error()
	//	c.JSON(http.StatusOK, res)
	...
	//}
	//
	//liveSectorCount, err = liveSectors.Count()
	//if err != nil {
	//	res.Code = model.Fail
	//	res.Msg = err.Error()
	//	c.JSON(http.StatusOK, res)
	...
	//}
	//
	//recoverSectors, err := miner.AllPartSectors(mas, miner.Partition.RecoveringSectors)
	//if err != nil {
	//	res.Code = model.Fail
	//	res.Msg = err.Error()
	//	c.JSON(http.StatusOK, res)
	...
	//}
	//
	//recoverSectorCount, err = recoverSectors.Count()
	//if err != nil {
	//	res.Code = model.Fail
	//	res.Msg = err.Error()
	//	c.JSON(http.StatusOK, res)
	...
	//}
	//
	//terminateSectorCount

	//if err = mas.ForEachDeadline(func(idx uint64, dl miner.Deadline) error {
	...
	//		}
	//
	//		sc, err := allSectors.Count()
	//		if err != nil {
	//			return err
	//		}
	//		sectorCount += sc
	//
	//		faultSectors, err := part.FaultySectors()
	//		if err != nil {
	//			return err
	//		}
	//
	//		fc, err := faultSectors.Count()
	//		if err != nil {
	//			return err
	//		}
	//		faultSectorCount += fc
	...
	//		}
	//
	//		lc, err := liveSectors.Count()
	//		if err != nil {
	//			return err
	//		}
	//		liveSectorCount += lc
	//
	//		recoverSectors, err := part.RecoveringSectors()
	//		if err != nil {
	//			return err
	//		}
	//
	//		rc, err := recoverSectors.Count()
	//		if err != nil {
	//			return err
	//		}
	//		recoverSectorCount += rc
	//
	//		unprovenSectors, err := part.UnprovenSectors()
	//		if err != nil {
	//			return err
	//		}
	//
	//		uc, err := unprovenSectors.Count()
	//		if err != nil {
	//			return err
	//		}
	//
	...
	resData.LockedFunds = lockedFunds.PreCommitDeposits //todo:不算init_pledge?
